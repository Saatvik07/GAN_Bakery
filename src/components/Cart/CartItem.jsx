			...
			<div className=' bg-accent-100 p-2 md:p-3 lg:p-4 flex items-center w-full'>
				...
				<div className='w-3/4 md:w-2/3 lg:w-3/4 flex items-center ml-2 md:ml-4 lg:ml-6 xl:ml-8 justify-between'>
					<div className='w-full flex flex-col'>
						<h1 className='text-textColor font-banner-heading font-bold text-[0.8rem] sm:text-base  md:text-lg xl:text-xl'>{`${product.title} ($ ${product.price})`}</h1>
				...
				<div className='w-1/4 sm:w-[15%] md:w-1/6 flex items-center justify-center'>
					...
					<IconButton
						iconName={iconButtonTypes.REMOVE_FROM_CART}
